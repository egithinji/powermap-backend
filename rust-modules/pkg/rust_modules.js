...
* @returns {number}
*/
module.exports.search_tweet = function(text, patterns) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.search_tweet(ptr0, len0, addHeapObject(patterns));
    return ret;
};
...
* @returns {any}
*/
module.exports.random_point = function(coords) {
    const ret = wasm.random_point(addHeapObject(coords));
...
module.exports.__wbg_floor_182f4f67bb2a06bd = typeof Math.floor == 'function' ? Math.floor : notDefined('Math.floor');
...
const path = require('path').join(__dirname, 'rust_modules_bg.wasm');
